...
class TokenReceiver:
    ...
    def auth(self):
        ...
        while 'error' in response_auth_json:
            ...
            if error == 'need_captcha':
                ...
                print('SMS with a confirmation code has been sent to your phone! The code is valid for a few minutes!')
                code = input('Code: ')
        ...
        if 'access_token' in response_auth_json:
            ...
            return True
        self.__error(response_auth_json)
        return False
    ...
    def save_to_config(self):
        ...
        if os.path.isfile('config_vk.ini'):
            ...
            if input().lower() != 'ok':
                return
        with open(self.get_path('config_vk.ini'), 'w') as output_file:
    ...
    def __error(response):
        ...
        with open(self.get_path('vktoken.error.log'), 'a') as output_file:
